...
const APPLY_FILE = argValue("--apply-file") || path.join(OUT_DIR, "approved-earrings-measurement-alt-updates.json");
...
if (!safeUpdates.length) {
  console.log("No approved earrings measurement alt updates found.");
  process.exit(0);
}
...
const output = path.join(OUT_DIR, "applied-earrings-measurement-alt-updates.json");
