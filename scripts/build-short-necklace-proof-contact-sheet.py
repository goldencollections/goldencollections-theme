#!/usr/bin/env python
"""Build a visual review contact sheet for deity short necklace image positions 2-4."""
...
ROOT = Path.cwd()
OUT_DIR = ROOT / "tmp" / "deity-short-necklace-ucp-sprint"
SOURCE = OUT_DIR / "short-necklace-visual-review.json"
IMAGE_DIR = OUT_DIR / "visual-review-images"
OUT_PATH = OUT_DIR / "short-necklace-visual-review-contact-sheet.jpg"
MAX_IMAGES = 45
THUMB_W = 300
THUMB_H = 300
LABEL_H = 116
