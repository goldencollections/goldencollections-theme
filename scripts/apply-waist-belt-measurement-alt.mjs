...
const APPLY_FILE = argValue("--apply-file") || path.join(OUT_DIR, "approved-waist-belt-measurement-alt-updates.json");
...
if (!safeUpdates.length) {
  console.log("No approved waist-belt measurement alt updates found.");
  process.exit(0);
}
...
const output = path.join(OUT_DIR, "applied-waist-belt-measurement-alt-updates.json");
