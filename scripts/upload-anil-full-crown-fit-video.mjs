...
const videoPath = path.join(
  ...
  "golden-collections-anil-tunk-full-crown-fit-guide-captioned.mp4"
);

const alt =
  "Anil Tunk of Golden Collections demonstrating full crown fit for a deity idol by measuring idol head width, crown opening, crown height and placement before choosing a deity crown.";
...
async function uploadVideo() {
  ...
  const outputPath = path.join(root, "tmp", "anil-full-crown-fit-video", "shopify-video-upload.json");
